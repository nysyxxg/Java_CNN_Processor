...
import com.flytxt.imageprocessor.utils.ClassReader;
/**
 * 
 * @author shiju.john
 *
...
public class ImageCoordinator {
	...
	private Path traingPath= Paths.get("src/main/resources/classdataset/image");
	private String classPath = "src/main/resources/classdataset/classes";
	...
	private ImageProcessor getImageProcessor() {
		try {
			new ClassReader().read(classPath);
	...
	public  Map<String, Object> getProperties() {		
		...
		builderProperties.put("EPOCHS",200);
	...
	private ImageConfiguration getImageConfiguration() {
		...
		imageConfig.addConfiguration(ImageConfiguration.TOTAL_IMAGE_COUNT, 30);
		imageConfig.addConfiguration("BATCH_SIZE",30);
		return imageConfig;
	}
