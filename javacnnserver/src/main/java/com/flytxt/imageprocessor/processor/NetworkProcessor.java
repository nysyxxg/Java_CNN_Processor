...
public class NetworkProcessor {
	...
	public String evaluate(DataSetRecordIterator dataSetIterator){
	    ...
	    dataSetIterator.reset(); 
	    DataSet dataset =  dataSetIterator.getDataIterator().next();
	    INDArray array = dataset.getFeatures();
	    List<INDArray> arrays = getMultiLayerNetwork().feedForward(array,false);
	    return  predictVal;
	}
